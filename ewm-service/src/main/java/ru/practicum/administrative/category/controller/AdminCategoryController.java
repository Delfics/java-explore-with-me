...
public class AdminCategoryController {
    ...
    public NewCategoryDto create(@RequestBody @Valid NewCategoryDto categoryDto) {
        ...
        return CategoryMapper.toCategoryDto(adminCategoryService.createCategory(CategoryMapper.toCategory(categoryDto)));
    }
    ...
    public NewCategoryDto update(@PathVariable(value = "catId") Long id, @RequestBody @Valid NewCategoryDto category) {
        ...
        return CategoryMapper.toCategoryDto(adminCategoryService.updateCategory(id, CategoryMapper.toCategory(category)));
    }
}
